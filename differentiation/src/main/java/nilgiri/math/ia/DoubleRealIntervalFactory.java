...
public class DoubleRealIntervalFactory implements AbstractRealNumberFactory<DoubleRealInterval>{
	...
	@Override
	public DoubleRealInterval acos(final DoubleRealInterval i_x) {
		return new DoubleRealInterval(IAMath.acos(i_x.viewInternal()));
	}

	@Override
	public DoubleRealInterval asin(final DoubleRealInterval i_x) {
		return new DoubleRealInterval(IAMath.asin(i_x.viewInternal()));
	}

	@Override
	public DoubleRealInterval atan(final DoubleRealInterval i_x) {
		return new DoubleRealInterval(IAMath.atan(i_x.viewInternal()));
	}
