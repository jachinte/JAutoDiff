...
public class DoubleRealFactory implements AbstractRealNumberFactory<DoubleReal> {
	...
	@Override
	public DoubleReal acos(final DoubleReal i_x) {
		return new DoubleReal(StrictMath.acos(i_x.doubleValue()));
	}

	@Override
	public DoubleReal asin(final DoubleReal i_x) {
		return new DoubleReal(StrictMath.asin(i_x.doubleValue()));
	}

	@Override
	public DoubleReal atan(final DoubleReal i_x) {
		return new DoubleReal(StrictMath.atan(i_x.doubleValue()));
	}
